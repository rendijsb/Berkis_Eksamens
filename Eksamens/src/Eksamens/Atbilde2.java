...
public class Atbilde2 extends JFrame implements ActionListener{
	JFrame frame;
	ImageIcon image;
	JLabel displayField;
	...
	Atbilde2(boolean jaut1, boolean jaut2) {
		this.jaut1=jaut1;
		this.jaut2=jaut2;
		frame = new JFrame();
		...
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
			...
			image = new ImageIcon(getClass().getResource("/bildes/Atbilde2.png"));
...
//        b1.setBorderPainted(false);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==b1) {
	        frame.dispose();
	        Jaut3 Jaut3 = new Jaut3(jaut1, jaut2);
	        }
