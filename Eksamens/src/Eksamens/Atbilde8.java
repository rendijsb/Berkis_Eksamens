...
public class Atbilde8 extends JFrame implements ActionListener{
	JFrame frame;
	ImageIcon image;
	JLabel displayField;
	...
	Atbilde8(boolean jaut1, boolean jaut2, boolean jaut3, boolean jaut4, boolean jaut5, boolean jaut6, boolean jaut7, boolean jaut8) {
		this.jaut1=jaut1;
		this.jaut2=jaut2;
		this.jaut3=jaut3;
		this.jaut4=jaut4;
...
//        b1.setBorderPainted(false);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==b1) {
	        frame.dispose();
	        Jaut9 Jaut9 = new Jaut9(jaut1, jaut2, jaut3, jaut4, jaut5, jaut6, jaut7, jaut8);
	        }
