...
public class Atbilde4 extends JFrame implements ActionListener{
	JFrame frame;
	ImageIcon image;
	JLabel displayField;
	...
	Atbilde4(boolean jaut1, boolean jaut2, boolean jaut3, boolean jaut4) {
		this.jaut1=jaut1;
		this.jaut2=jaut2;
		this.jaut3=jaut3;
		this.jaut4=jaut4;
		...
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
			...
			image = new ImageIcon(getClass().getResource("/bildes/Atbilde4.png"));
...
//        b1.setBorderPainted(false);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==b1) {
	        frame.dispose();
	        Jaut5 Jaut5 = new Jaut5(jaut1, jaut2, jaut3, jaut4);
	        }
