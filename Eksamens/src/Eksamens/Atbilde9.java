...
public class Atbilde9 extends JFrame implements ActionListener{
	JFrame frame;
	ImageIcon image;
	JLabel displayField;
	...
	Atbilde9(boolean jaut1, boolean jaut2, boolean jaut3, boolean jaut4, boolean jaut5, boolean jaut6, boolean jaut7, boolean jaut8, boolean jaut9) {
		this.jaut1=jaut1;
		this.jaut2=jaut2;
		this.jaut3=jaut3;
		this.jaut4=jaut4;
		...
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
			...
			image = new ImageIcon(getClass().getResource("/bildes/Atbilde9.png"));
...
//        b1.setBorderPainted(false);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==b1) {
	        frame.dispose();
	        Jaut10 Jaut10 = new Jaut10(jaut1, jaut2, jaut3, jaut4, jaut5, jaut6, jaut7, jaut8, jaut9);
	        }
